...
WordGame = function (startingString = "", dictionary = wordList) {
  ...
  */
  this.lettersMatch = function(word) {
    ...
    return !Object.entries(countCharacters(word))
      .some(([char, count]) => count > letterCount[char] )
  }
  ...
  */
  ...
  this.validateWord = function(word) {
    return this.lettersMatch(word) && this.checkHighScore(word) && this.checkDictionary(word);
  }
